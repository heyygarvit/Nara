...
# Pass the model's weights to the RAdam optimizer
optimizer = RAdam([model.weights], learning_rate=0.01)
...
for epoch in range(epochs):
    ...
    # Update weights using RAdam optimizer
    optimizer.step([model.weights.grad])
